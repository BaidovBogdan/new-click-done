...
export default function BlogGridCard({
  ...
  return (
    <div className='bg-white rounded-3xl w-[352px] h-[356px] sm:w-[384px] sm:h-[374px]'>
      <div className='flex flex-col gap-2 p-2'>
        ...
        <div className='flex flex-col p-2 justify-between h-[115px] sm:h-[95px]'>
          <div className='HeadingFS5 font-medium text-[#1D1D1FE5] sm:HeadingFS4 w-[318px] sm:w-[352px]'>
            {desc}
          </div>
